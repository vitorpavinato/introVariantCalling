...
a demonstração diretamente no navegador, sem nenhuma instalação.
...
A última seção usa o [IGV-Web](https://igv.org/app/) — que roda no navegador, sem instalação.
Para isso, três arquivos pequenos são versionados: o genoma referência `ecoli_rel606.fasta`,
...
> ⚠️ Problemas identificados: o link do NCBI citado na página do episódio
> (`GCA_000017985.1_ASM1798v1`) baixa um arquivo provavelmente corrompido; e **não** se deve usar
> o genoma de *E. coli* K-12 MG1655 (ASM584v2, 4.641.652 bp) — os *reads* são da
> linhagem B/REL606, e se mapeá-los contra K-12 gera ~31.000 variantes (divergência
